...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.fightingentropy.voiceink.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.fightingentropy.voiceink.onboardingWindow")
